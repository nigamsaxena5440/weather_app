...
//               colors: [Color(0xFFEC8119), Color(0xFFE6A68D)],
...
class HomeScreen extends StatelessWidget {
  ...
  List<Color> _getWeatherGradient(String? condition) {
    if (condition == null) {
      return [const Color(0xFFEC8119), const Color(0xFFE6A68D)];
    }

    final text = condition.toLowerCase();

    if (text.contains("sunny") || text.contains("clear")) {
      return [const Color(0xFFFFA726), const Color(0xFFFFE082)]; // ☀️
    } else if (text.contains("cloud")) {
      return [const Color(0xFF90A4AE), const Color(0xFFCFD8DC)]; // ☁️
    } else if (text.contains("rain") || text.contains("drizzle")) {
      return [const Color(0xFF5C6BC0), const Color(0xFF7986CB)]; // 🌧️
    } else if (text.contains("thunder")) {
      return [const Color(0xFF37474F), const Color(0xFF546E7A)]; // ⚡
    } else if (text.contains("snow")) {
      return [const Color(0xFFE1F5FE), const Color(0xFFB3E5FC)]; // ❄️
    } else {
      return [const Color(0xFFEC8119), const Color(0xFFE6A68D)];
    }
  }
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildInfo(
                            "Wind", "${current?.windKph ?? 0} kph"),
                        _buildInfo(
                            "Cloud", "${current?.cloud ?? 0}%"),
                        _buildInfo(
                            "Humidity", "${current?.humidity ?? 0}%"),
                        _buildInfo("Feels Like",
                            "${current?.feelslikeC ?? 0}°"),
